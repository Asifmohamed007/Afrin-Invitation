...
To run **Wedding Reception Invitation Website** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/Afrin-Invitation.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/Afrin-Invitation.git
```
